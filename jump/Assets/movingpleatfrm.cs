...
public class movingpleatfrm : MonoBehaviour
{
    ...
    private void OnDrawGizmos()
    {
        if (platformPosition[0]!=null&& platformPosition[1]!=null&& platformPosition[2]!=null)
        {
            ...
            Gizmos.DrawLine(platformPosition[0].transform.position, platformPosition[1].position);
            Gizmos.DrawLine(platformPosition[0].transform.position, platformPosition[2].position);
        }
    }
